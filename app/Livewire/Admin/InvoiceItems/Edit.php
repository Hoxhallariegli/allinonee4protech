...
use App\Domain\InvoiceItem\Actions\UpdateInvoiceItemAction;
...
class Edit extends Component
{
 ...
 public InvoiceItem $item;
    ...
    public function render() { abort_if_cannot('edit_invoice_items'); return view('livewire.admin.invoice-items.edit', [
    ...
    public function update(UpdateInvoiceItemAction $action) { $this->validate();  $dto = InvoiceItemDTO::fromArray([
            ...
            'price' => $this->price,
        ]); $action->execute($this->item, $dto); session()->flash('success', __('invoice-items.updated')); return to_route('admin.invoice-items.index'); }
