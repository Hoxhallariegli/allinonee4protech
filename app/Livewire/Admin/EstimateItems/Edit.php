...
use App\Domain\EstimateItem\Actions\UpdateEstimateItemAction;
...
class Edit extends Component
{
 ...
 public EstimateItem $item;
    ...
    public function render() { abort_if_cannot('edit_estimate_items'); return view('livewire.admin.estimate-items.edit', [
    ...
    public function update(UpdateEstimateItemAction $action) { $this->validate();  $dto = EstimateItemDTO::fromArray([
        ...
        ]); $action->execute($this->item, $dto); session()->flash('success', __('estimate-items.updated')); return to_route('admin.estimate-items.index'); }
