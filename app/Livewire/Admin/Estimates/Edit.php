...
use App\Domain\Estimate\Actions\UpdateEstimateAction;
...
class Edit extends Component
{
 ...
 public Estimate $item;
    ...
    public function render() { abort_if_cannot('edit_estimates'); return view('livewire.admin.estimates.edit', [
    ...
    public function update(UpdateEstimateAction $action) { $this->validate();  $dto = EstimateDTO::fromArray([
            ...
            'status' => $this->status,
        ]); $action->execute($this->item, $dto); session()->flash('success', __('estimates.updated')); return to_route('admin.estimates.index'); }
