...
class Edit extends Component
{
 ...
 public Contact $item;
    ...
    public function render() { abort_if_cannot('edit_contacts'); return view('livewire.admin.c-r-m.contacts.edit', [
            'companies' => $this->getcompaniesList(),
        ])->layout('components.layouts.app'); }
    public function update(UpdateContactAction $action) { $this->validate();  $dto = ContactDTO::fromArray([
            'name' => $this->name,
