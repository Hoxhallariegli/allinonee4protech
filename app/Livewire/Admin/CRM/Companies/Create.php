...
class Create extends Component
{
    ...
    public function render() { abort_if_cannot('add_companies'); return view('livewire.admin.c-r-m.companies.create', [
        ])->layout('components.layouts.app'); }
    public function store(CreateCompanyAction $action) { $this->validate();  $dto = CompanyDTO::fromArray([
            'name' => $this->name,
