...
class Edit extends Component
{
 ...
 public Agent $item;
    ...
    public function render() {
        abort_if_cannot('edit_agents');
        return view('livewire.admin.real-estate-c-r-m.agents.edit', [
        ])->layout('components.layouts.app');
    }
    public function update(UpdateAgentAction $action) { $this->validate();         if ($this->photo && !is_string($this->photo)) { $this->photo = $this->photo->store('uploads/agents', 'uploads'); }
