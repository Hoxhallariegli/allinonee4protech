...
use App\Domain\RealEstateCRM\Contract\Actions\UpdateContractAction;
...
class Edit extends Component
{
 ...
 public Contract $item;
    ...
    public function update(UpdateContractAction $action) { $this->validate();  $dto = ContractDTO::fromArray([
            ...
            'amount' => $this->amount,
        ]); $action->execute($this->item, $dto); session()->flash('success', __('real-estate-c-r-m/contracts.updated')); return to_route('admin.real-estate-c-r-m.contracts.index'); }
