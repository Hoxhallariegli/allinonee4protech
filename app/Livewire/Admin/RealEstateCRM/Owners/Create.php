...
class Create extends Component
{
    ...
    public function render() {
        abort_if_cannot('add_owners');
        return view('livewire.admin.real-estate-c-r-m.owners.create', [
        ])->layout('components.layouts.app');
    }
    public function store(CreateOwnerAction $action) { $this->validate();         if ($this->photo && !is_string($this->photo)) { $this->photo = $this->photo->store('uploads/owners', 'uploads'); }
