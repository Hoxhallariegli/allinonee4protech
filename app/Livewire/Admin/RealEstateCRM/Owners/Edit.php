...
class Edit extends Component
{
 ...
 public Owner $item;
    ...
    public function render() { abort_if_cannot('edit_owners'); return view('livewire.admin.real-estate-c-r-m.owners.edit', [
        ])->layout('components.layouts.app'); }
    public function update(UpdateOwnerAction $action) { $this->validate();  $dto = OwnerDTO::fromArray([
            'name' => $this->name,
            'phone' => $this->phone,
            'email' => $this->email,
