...
class Create extends Component
{
    ...
    public function render() { abort_if_cannot('add_property_visits'); return view('livewire.admin.real-estate-c-r-m.property-visits.create', [
            'properties' => $this->getpropertiesList(),
            'clients' => $this->getclientsList(),
        ])->layout('components.layouts.app'); }
    public function store(CreatePropertyVisitAction $action) { $this->validate();  $dto = PropertyVisitDTO::fromArray([
            'property_id' => $this->property_id,
            'client_id' => $this->client_id,
            'visit_date' => $this->visit_date,
        ]); $action->execute($dto); session()->flash('success', __('real-estate-c-r-m/property-visits.created')); return to_route('admin.real-estate-c-r-m.property-visits.index'); }
