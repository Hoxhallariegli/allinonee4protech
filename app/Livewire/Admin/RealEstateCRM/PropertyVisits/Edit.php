...
class Edit extends Component
{
 ...
 public PropertyVisit $item;
    ...
    public function mount(PropertyVisit $propertyVisit) { $this->item = $propertyVisit; $this->fill($propertyVisit->toArray()); $this->visit_date = $propertyVisit->visit_date?->format('Y-m-d\TH:i'); }
    public function render() { abort_if_cannot('edit_property_visits'); return view('livewire.admin.real-estate-c-r-m.property-visits.edit', [
