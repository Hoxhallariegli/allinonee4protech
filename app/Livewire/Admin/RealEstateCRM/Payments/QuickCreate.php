...
class QuickCreate extends Component
{
    ...
    public function render() { return view('livewire.admin.real-estate-c-r-m.payments.quick-create', [
    ...
    public function store(CreatePaymentAction $action)
    {
        ...
        $this->dispatch('toast', message: __('real-estate-c-r-m/payments.created'), type: 'success');
        $this->created = true;
