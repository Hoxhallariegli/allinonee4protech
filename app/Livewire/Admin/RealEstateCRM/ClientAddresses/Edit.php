...
use App\Domain\RealEstateCRM\ClientAddress\Actions\UpdateClientAddressAction;
...
class Edit extends Component
{
 ...
 public ClientAddress $item;
    ...
    public function render() {
        ...
        return view('livewire.admin.real-estate-c-r-m.client-addresses.edit', [
    ...
    public function update(UpdateClientAddressAction $action) { $this->validate();  $dto = ClientAddressDTO::fromArray([
        ...
        ]); $action->execute($this->item, $dto); session()->flash('success', __('real-estate-c-r-m/client-addresses.updated')); return to_route('admin.real-estate-c-r-m.client-addresses.index'); }
