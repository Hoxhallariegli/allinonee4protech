...
use App\Domain\Invoice\Actions\UpdateInvoiceAction;
...
class Edit extends Component
{
 ...
 public Invoice $item;
    ...
    public function render() { abort_if_cannot('edit_invoices'); return view('livewire.admin.invoices.edit', [
    ...
    public function update(UpdateInvoiceAction $action) { $this->validate();  $dto = InvoiceDTO::fromArray([
            ...
            'total' => $this->total,
            'status' => $this->status,
        ]); $action->execute($this->item, $dto); session()->flash('success', __('invoices.updated')); return to_route('admin.invoices.index'); }
