...
class QuickCreate extends Component
{
    ...
    public function render() { return view('livewire.admin.travel-agency.clients.quick-create', [
        ]); }
    ...
    public function store(CreateClientAction $action)
    {
        ...
        $this->dispatch('toast', message: __('travel-agency/clients.created'), type: 'success');
        $this->created = true;
