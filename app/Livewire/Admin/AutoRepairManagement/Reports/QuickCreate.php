...
class QuickCreate extends Component
{
    ...
    public function render() { return view('livewire.admin.auto-repair-management.reports.quick-create', [
        ]); }
    ...
    public function store(CreateReportAction $action)
    {
        ...
        $this->dispatch('toast', message: __('auto-repair-management/reports.created'), type: 'success');
        $this->created = true;
