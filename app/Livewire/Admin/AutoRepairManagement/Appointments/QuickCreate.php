...
class QuickCreate extends Component
{
    ...
    public function render() { return view('livewire.admin.auto-repair-management.appointments.quick-create', [
    ...
    public function store(CreateAppointmentAction $action)
    {
        ...
        $this->dispatch('toast', message: __('auto-repair-management/appointments.created'), type: 'success');
        $this->created = true;
