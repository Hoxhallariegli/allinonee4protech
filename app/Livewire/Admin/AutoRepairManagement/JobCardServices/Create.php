...
class Create extends Component
{
    ...
    public function store(CreateJobCardServiceAction $action) { $this->validate();  $dto = JobCardServiceDTO::fromArray([
            ...
            'price' => $this->price,
        ]); $action->execute($dto); session()->flash('success', __('auto-repair-management/job-card-services.created')); return to_route('admin.auto-repair-management.job-card-services.index'); }
