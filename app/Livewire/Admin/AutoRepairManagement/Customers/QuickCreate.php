...
class QuickCreate extends Component
{
    ...
    public function render() { return view('livewire.admin.auto-repair-management.customers.quick-create', [
        ]); }
    ...
    public function store(CreateCustomerAction $action)
    {
        ...
        $this->dispatch('toast', message: __('auto-repair-management/customers.created'), type: 'success');
        $this->created = true;
