...
use App\Domain\AutoRepairManagement\Mechanic\Actions\UpdateMechanicAction;
...
class Edit extends Component
{
 ...
 public Mechanic $item;
    ...
    public function update(UpdateMechanicAction $action) { $this->validate();  $dto = MechanicDTO::fromArray([
        ...
        ]); $action->execute($this->item, $dto); session()->flash('success', __('auto-repair-management/mechanics.updated')); return to_route('admin.auto-repair-management.mechanics.index'); }
