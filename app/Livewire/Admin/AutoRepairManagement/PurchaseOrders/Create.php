...
class Create extends Component
{
    ...
    public function store(CreatePurchaseOrderAction $action) { $this->validate();  $dto = PurchaseOrderDTO::fromArray([
            ...
            'status' => $this->status,
        ]); $action->execute($dto); session()->flash('success', __('auto-repair-management/purchase-orders.created')); return to_route('admin.auto-repair-management.purchase-orders.index'); }
