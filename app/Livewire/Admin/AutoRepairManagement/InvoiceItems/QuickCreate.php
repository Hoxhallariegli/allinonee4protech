...
class QuickCreate extends Component
{
    ...
    public function render() { return view('livewire.admin.auto-repair-management.invoice-items.quick-create', [
    ...
    public function store(CreateInvoiceItemAction $action)
    {
        ...
        $this->dispatch('toast', message: __('auto-repair-management/invoice-items.created'), type: 'success');
        $this->created = true;
