...
use App\Domain\AutoRepairManagement\Employee\Actions\CreateEmployeeAction;
...
class QuickCreate extends Component
{
    ...
    public function render() { return view('livewire.admin.auto-repair-management.employees.quick-create', [
        ]); }
    ...
    public function store(CreateEmployeeAction $action)
    {
        ...
        $this->dispatch('toast', message: __('auto-repair-management/employees.created'), type: 'success');
        $this->created = true;
