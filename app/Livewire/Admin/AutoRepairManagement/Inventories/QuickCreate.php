...
class QuickCreate extends Component
{
    ...
    public function render() { return view('livewire.admin.auto-repair-management.inventories.quick-create', [
    ...
    public function store(CreateInventoryAction $action)
    {
        ...
        $this->dispatch('toast', message: __('auto-repair-management/inventories.created'), type: 'success');
        $this->created = true;
