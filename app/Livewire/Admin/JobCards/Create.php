...
use App\Domain\JobCard\Actions\CreateJobCardAction;
...
class Create extends Component
{
    ...
    public function render() { abort_if_cannot('add_job_cards'); return view('livewire.admin.job-cards.create', [
    ...
    public function store(CreateJobCardAction $action) { $this->validate();  $dto = JobCardDTO::fromArray([
        ...
        ]); $action->execute($dto); session()->flash('success', __('job-cards.created')); return to_route('admin.job-cards.index'); }
