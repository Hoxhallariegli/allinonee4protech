...
class Dashboard extends Component
{
    public function render()
    {
        ...
        $chartData['sales'] = collect(range(6, 0))->map(fn($i) => (float) \App\Models\PharmacyManagement\Sale::whereDate('created_at', now()->subDays($i))->sum('total_amount'))->toArray();
        ...
        return view('livewire.admin.pharmacy-management.dashboard', [
            ...
            'sales_sum' => (float) \App\Models\PharmacyManagement\Sale::sum('total_amount'),
