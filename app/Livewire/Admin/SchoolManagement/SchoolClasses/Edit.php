...
use App\Domain\SchoolManagement\SchoolClass\Actions\UpdateSchoolClassAction;
...
#[Title('Edit SchoolClass')]
class Edit extends Component
{
        use WithPagination;
 public SchoolClass $item;
    public $name = '';
    public $teacher_id = '';
    public $capacity = '';
    ...
    public function update(UpdateSchoolClassAction $action) { $this->validate();  $dto = SchoolClassDTO::fromArray([
        ...
        ]); $action->execute($this->item, $dto); session()->flash('success', __('school-management/school-classes.updated')); return to_route('admin.school-management.school-classes.index'); }
    protected function rules(): array { return SchoolClass::rules($this->item->id); }
}