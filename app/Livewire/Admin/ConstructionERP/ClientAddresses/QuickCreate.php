...
class QuickCreate extends Component
{
    ...
    public function render() { return view('livewire.admin.construction-e-r-p.client-addresses.quick-create', [
    ...
    public function store(CreateClientAddressAction $action)
    {
        ...
        $this->dispatch('toast', message: __('construction-e-r-p/client-addresses.created'), type: 'success');
        $this->created = true;
