...
class QuickCreate extends Component
{
    ...
    public function render() { return view('livewire.admin.construction-e-r-p.suppliers.quick-create', [
        ]); }
    ...
    public function store(CreateSupplierAction $action)
    {
        ...
        $this->dispatch('toast', message: __('construction-e-r-p/suppliers.created'), type: 'success');
        $this->created = true;
