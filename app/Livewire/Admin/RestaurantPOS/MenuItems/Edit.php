...
class Edit extends Component
{
 ...
 public MenuItem $item;
    ...
    public function render() { abort_if_cannot('edit_menu_items'); return view('livewire.admin.restaurant-p-o-s.menu-items.edit', [
        ])->layout('components.layouts.app'); }
    public function update(UpdateMenuItemAction $action) { $this->validate();  $dto = MenuItemDTO::fromArray([
            'name' => $this->name,
            'price' => $this->price,
