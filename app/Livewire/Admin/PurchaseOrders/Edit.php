...
use App\Domain\PurchaseOrder\Actions\UpdatePurchaseOrderAction;
...
class Edit extends Component
{
 ...
 public PurchaseOrder $item;
    ...
    public function render() { abort_if_cannot('edit_purchase_orders'); return view('livewire.admin.purchase-orders.edit', [
    ...
    public function update(UpdatePurchaseOrderAction $action) { $this->validate();  $dto = PurchaseOrderDTO::fromArray([
            ...
            'status' => $this->status,
        ]); $action->execute($this->item, $dto); session()->flash('success', __('purchase-orders.updated')); return to_route('admin.purchase-orders.index'); }
