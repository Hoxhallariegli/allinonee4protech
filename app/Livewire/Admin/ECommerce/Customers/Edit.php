...
use App\Domain\ECommerce\Customer\Actions\UpdateCustomerAction;
...
class Edit extends Component
{
 ...
 public Customer $item;
    ...
    public function render() {
        ...
        return view('livewire.admin.e--commerce.customers.edit', [
    ...
    public function update(UpdateCustomerAction $action) { $this->validate();  $dto = CustomerDTO::fromArray([
            ...
            'email' => $this->email,
            'phone' => $this->phone,
        ]); $action->execute($this->item, $dto); session()->flash('success', __('e--commerce/customers.updated')); return to_route('admin.e--commerce.customers.index'); }
