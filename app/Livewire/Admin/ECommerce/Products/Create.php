...
class Create extends Component
{
    ...
    public function render() {
        ...
        return view('livewire.admin.e--commerce.products.create', [
    ...
    public function store(CreateProductAction $action) { $this->validate();  $dto = ProductDTO::fromArray([
        ...
        ]); $action->execute($dto); session()->flash('success', __('e--commerce/products.created')); return to_route('admin.e--commerce.products.index'); }
