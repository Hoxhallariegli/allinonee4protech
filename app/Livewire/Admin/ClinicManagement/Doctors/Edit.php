...
class Edit extends Component
{
 ...
 public Doctor $item;
    ...
    public function render() { abort_if_cannot('edit_doctors'); return view('livewire.admin.clinic-management.doctors.edit', [
        ])->layout('components.layouts.app'); }
    public function update(UpdateDoctorAction $action) { $this->validate();  $dto = DoctorDTO::fromArray([
            'name' => $this->name,
