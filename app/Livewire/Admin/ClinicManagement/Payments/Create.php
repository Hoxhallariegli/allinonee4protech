...
class Create extends Component
{
    ...
    public function render() {
        ...
        return view('livewire.admin.clinic-management.payments.create', [
    ...
    public function store(CreatePaymentAction $action) { $this->validate();  $dto = PaymentDTO::fromArray([
        ...
        ]); $action->execute($dto); session()->flash('success', __('clinic-management/payments.created')); return to_route('admin.clinic-management.payments.index'); }
