...
use App\Domain\ClinicManagement\Visit\Actions\UpdateVisitAction;
...
class Edit extends Component
{
 ...
 public Visit $item;
    ...
    public function update(UpdateVisitAction $action) { $this->validate();  $dto = VisitDTO::fromArray([
        ...
        ]); $action->execute($this->item, $dto); session()->flash('success', __('clinic-management/visits.updated')); return to_route('admin.clinic-management.visits.index'); }
    protected function rules(): array { return Visit::rules($this->item->id); }
}