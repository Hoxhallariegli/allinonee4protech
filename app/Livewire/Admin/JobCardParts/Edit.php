...
use App\Domain\JobCardPart\Actions\UpdateJobCardPartAction;
...
class Edit extends Component
{
 ...
 public JobCardPart $item;
    ...
    public function render() { abort_if_cannot('edit_job_card_parts'); return view('livewire.admin.job-card-parts.edit', [
    ...
    public function update(UpdateJobCardPartAction $action) { $this->validate();  $dto = JobCardPartDTO::fromArray([
            ...
            'price' => $this->price,
        ]); $action->execute($this->item, $dto); session()->flash('success', __('job-card-parts.updated')); return to_route('admin.job-card-parts.index'); }
