...
class QuickCreate extends Component
{
    ...
    public function render() { return view('livewire.admin.warehouse-management.purchase-orders.quick-create', [
    ...
    public function store(CreatePurchaseOrderAction $action)
    {
        ...
        $this->dispatch('toast', message: __('warehouse-management/purchase-orders.created'), type: 'success');
        $this->created = true;
