...
class QuickCreate extends Component
{
    ...
    public function render() { return view('livewire.admin.purchase-order-items.quick-create', [
    ...
    public function store(CreatePurchaseOrderItemAction $action)
    {
        ...
        $this->dispatch('toast', message: __('purchase-order-items.created'), type: 'success');
        $this->created = true;
