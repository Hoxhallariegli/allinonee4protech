...
use App\Domain\PurchaseOrderItem\Actions\CreatePurchaseOrderItemAction;
...
class Create extends Component
{
    ...
    public function render() { abort_if_cannot('add_purchase_order_items'); return view('livewire.admin.purchase-order-items.create', [
    ...
    public function store(CreatePurchaseOrderItemAction $action) { $this->validate();  $dto = PurchaseOrderItemDTO::fromArray([
            ...
            'price' => $this->price,
        ]); $action->execute($dto); session()->flash('success', __('purchase-order-items.created')); return to_route('admin.purchase-order-items.index'); }
