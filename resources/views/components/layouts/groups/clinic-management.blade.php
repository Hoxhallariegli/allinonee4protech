...
>
  ...
  >
    <div class="flex h-16 w-full flex-none items-center justify-between px-6 lg:justify-start gap-3 bg-rose-600 dark:bg-rose-900">
      <x-heroicon-o-heart class="size-6 text-white" />
      <span class="text-lg font-black tracking-widest text-white uppercase">{{ __('front/clinic-management.title') }}</span>
