<div class="space-y-10">
    <div class="flex items-center justify-between gap-4 px-1"><div><x-h1>{{ __('berber-app/reminders.Add Reminder') }}</x-h1><x-short-description class="dark:text-gray-400">{{ __('berber-app/reminders.New record') }}</x-short-description></div><x-back-btn route="admin.berber-app.reminders.index" /></div>
