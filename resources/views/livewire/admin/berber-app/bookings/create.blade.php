...
<div><x-form.input name="appointment_datetime" type="datetime-local" wire:model="appointment_datetime" :label="__('berber-app/bookings.Appointment Datetime')" class="dark:bg-gray-900" /></div></div><div class="mt-10 flex justify-end"><x-button type="submit" variant="blue" class="w-full sm:w-auto !px-12 !py-4 !rounded-2xl">{{ __('berber-app/bookings.Save') }}</x-button></div></form></div>
</div>