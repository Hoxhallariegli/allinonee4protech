<div class="space-y-10">
    <div class="flex items-center justify-between gap-4 px-1"><div><x-h1>{{ __('facility-management/maintenance-requests.Add MaintenanceRequest') }}</x-h1><x-short-description class="dark:text-gray-400">{{ __('facility-management/maintenance-requests.New record') }}</x-short-description></div><x-back-btn route="admin.facility-management.maintenance-requests.index" /></div>
