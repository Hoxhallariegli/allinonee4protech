<div class="space-y-10">
    <div class="flex items-center justify-between gap-4 px-1"><div><x-h1>{{ __('c-r-m/contacts.Edit Contact') }}</x-h1><x-short-description class="dark:text-gray-400">{{ __('c-r-m/contacts.Update info') }}</x-short-description></div><x-back-btn route="admin.c-r-m.contacts.index" /></div>
    @include('errors.errors')
    <div class="bg-white dark:bg-gray-800 p-8 sm:p-12 rounded-[2.5rem] shadow-sm border border-gray-50 dark:border-gray-700"><form wire:submit.prevent="update" class="space-y-8"><div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8"><div><x-form.input name="name" type="text" wire:model="name" :label="__('c-r-m/contacts.Name')" class="dark:bg-gray-900" /></div>
<div>
