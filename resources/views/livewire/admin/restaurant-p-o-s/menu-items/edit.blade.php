<div class="space-y-10">
    <div class="flex items-center justify-between gap-4 px-1"><div><x-h1>{{ __('restaurant-p-o-s/menu-items.Edit MenuItem') }}</x-h1><x-short-description class="dark:text-gray-400">{{ __('restaurant-p-o-s/menu-items.Update info') }}</x-short-description></div><x-back-btn route="admin.restaurant-p-o-s.menu-items.index" /></div>
