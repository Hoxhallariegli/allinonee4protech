<div class="space-y-10">
    <div class="flex items-center justify-between gap-4 px-1"><div><x-h1>{{ __('restaurant-p-o-s/orders.Add Order') }}</x-h1><x-short-description class="dark:text-gray-400">{{ __('restaurant-p-o-s/orders.New record') }}</x-short-description></div><x-back-btn route="admin.restaurant-p-o-s.orders.index" /></div>
