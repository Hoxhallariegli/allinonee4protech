<div class="space-y-10">
    <div class="flex items-center justify-between gap-4 px-1"><div><x-h1>{{ __('pharmacy-management/prescription-items.Add PrescriptionItem') }}</x-h1><x-short-description class="dark:text-gray-400">{{ __('pharmacy-management/prescription-items.New record') }}</x-short-description></div><x-back-btn route="admin.pharmacy-management.prescription-items.index" /></div>
