<div class="space-y-10">
    <div class="flex items-center justify-between gap-4 px-1"><div><x-h1>{{ __('auto-repair-management/vehicles.Edit Vehicle') }}</x-h1><x-short-description class="dark:text-gray-400">{{ __('auto-repair-management/vehicles.Update info') }}</x-short-description></div><x-back-btn route="admin.auto-repair-management.vehicles.index" /></div>
...
<div><x-form.input name="vin" type="text" wire:model="vin" :label="__('auto-repair-management/vehicles.Vin')" class="dark:bg-gray-900" /></div></div><div class="mt-10 flex justify-end"><x-button type="submit" variant="blue" class="w-full sm:w-auto !px-12 !py-4 !rounded-2xl">{{ __('auto-repair-management/vehicles.Update') }}</x-button></div></form></div>
</div>