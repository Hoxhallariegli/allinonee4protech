<div class="space-y-10">
    <div class="flex items-center justify-between gap-4 px-1"><div><x-h1>{{ __('auto-repair-management/job-cards.Add JobCard') }}</x-h1><x-short-description class="dark:text-gray-400">{{ __('auto-repair-management/job-cards.New record') }}</x-short-description></div><x-back-btn route="admin.auto-repair-management.job-cards.index" /></div>
