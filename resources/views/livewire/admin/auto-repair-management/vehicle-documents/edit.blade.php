...
</div></div><div class="mt-10 flex justify-end"><x-button type="submit" variant="blue" class="w-full sm:w-auto !px-12 !py-4 !rounded-2xl">{{ __('auto-repair-management/vehicle-documents.Update') }}</x-button></div></form></div>
</div>