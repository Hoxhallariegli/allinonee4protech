    ...
    <div class="card !p-0 overflow-hidden shadow-none border-gray-200 dark:border-gray-700 dark:bg-gray-800">
        ...
        <div class="overflow-x-auto border-t border-gray-100 dark:border-gray-700">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="bg-gray-100/50 dark:bg-gray-700/50"><tr><x-table.th name="id" :label="__('vehicle-models.ID')" :$sortField :$sortAsc :sortable="true" /><x-table.th name="name" :label="__('vehicle-models.Name')" :$sortField :$sortAsc :sortable="in_array('name', $sortableFields)" />
<x-table.th name="brand_id" :label="__('vehicle-models.Brand Id')" :$sortField :$sortAsc :sortable="in_array('brand_id', $sortableFields)" /><th class="px-6 py-4 text-right text-[10px] font-black uppercase text-gray-400 tracking-widest">{{ __('vehicle-models.Action') }}</th></tr></thead>
