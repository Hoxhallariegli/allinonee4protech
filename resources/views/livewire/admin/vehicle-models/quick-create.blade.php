<div class="p-6">
    ...
    @else
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8"><div><x-form.input name="name" type="text" wire:model="name" :label="__('vehicle-models.Name')" class="dark:bg-gray-900" /></div>
<div>
    <div class="flex items-end gap-2">
        ...
        <div class="mt-8 flex justify-end"><x-button wire:click="store" variant="blue">{{ __('vehicle-models.Save') }}</x-button></div>
    @endif
</div>