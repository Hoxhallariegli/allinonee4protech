...
<div><label class="block mb-1.5 text-[10px] font-bold uppercase tracking-widest">{{ __('real-estate-c-r-m/properties.No') }}</label><select name="no" wire:model="no" class="w-full p-3 text-sm font-bold bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl"><option value="">--</option><option value=\"apartment\">apartment</option><option value=\"house\">house</option><option value=\"land\">land</option></select></div></div>
