...
<div><x-form.input name="phone" type="text" wire:model="phone" :label="__('suppliers.Phone')" class="dark:bg-gray-900" /></div></div><div class="mt-10 flex justify-end"><x-button type="submit" variant="blue" class="w-full sm:w-auto !px-12 !py-4 !rounded-2xl">{{ __('suppliers.Update') }}</x-button></div></form></div>
</div>