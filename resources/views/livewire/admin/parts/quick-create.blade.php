<div class="p-6">
    ...
    @else
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8"><div><x-form.input name="name" type="text" wire:model="name" :label="__('parts.Name')" class="dark:bg-gray-900" /></div>
<div><x-form.input name="price" type="text" wire:model="price" :label="__('parts.Price')" class="dark:bg-gray-900" /></div>
<div><x-form.input name="stock" type="text" wire:model="stock" :label="__('parts.Stock')" class="dark:bg-gray-900" /></div></div>
